...
function validarXML() {
	...
	xhr.open("GET", "https://daviiidd26.github.io/proyectoweb/ficheroXML.xml", true);
	xhr.send();
}
...
function miFuncion(xml) {
	...
	var usrPsw;
	var estado = false;
	var userLog = document.forms["formulario"]["usuario"].value;
	var passLog = document.forms["formulario"]["contraseña"].value;
	...
	if (estado == true) {
		sessionStorage.setItem("nomUsr", document.forms["formulario"]["usuario"].value);
	} else {
